...
You can style this button with CSS of course, but also and above with a system based CSS. Let's try it:
...
const Button = styled.button`
  ...
  margin: 0 ${props => theme.spaces[3]};
  padding: ${props => theme.spaces[1]} ${props => theme.spaces[3]};
`
```
...
If it looks too magic for you? Start with [theme getters](http://localhost:8000/docs/system-utilities/#theme-getters).
