...
With xstyled, we talk a lot about theming, but what is it? Theming is one of the core features of [styled-components](https://www.styled-components.com/). It permits you to provide a theme object that is accessible by all of your styled components!

## How does it work?

xstyled works without any theme, but using a theme really gives super powers! With xstyled, all css properties are directly bound to a theme value (see [theme specification](/docs/theme-specification/) for more detail), so you can rely on the theme without thinking about it.
