...
<>
  <template preview>
    <x.p textTransform="none" fontSize="xl" color="emerald-600">
...
<>
  <template preview>
    <x.p textTransform="uppercase" fontSize="xl" color="red-600">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
...
<>
  <template preview>
    <x.p textTransform="lowercase" fontSize="xl" color="violet-600">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
...
<>
  <template preview>
    <x.p textTransform="capitalize" fontSize="xl" color="amber-600">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
