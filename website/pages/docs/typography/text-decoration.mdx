...
<>
  <template preview>
    <x.p textDecoration="underline" fontSize="xl" color="emerald-600">
...
<>
  <template preview>
    <x.p textDecoration="line-through" fontSize="xl" color="red-600">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
...
<>
  <template preview>
    <x.p textDecoration="none" fontSize="xl" color="indigo-600">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
