...
<>
  <template preview>
    <x.p fontFamily="mono" fontSize="xl" color="indigo-600" textAlign="center">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
...
<>
  <template preview>
    <x.p fontFamily="arial" fontSize="xl" color="rose-600" textAlign="center">
      Computers have lots of memory but no imagination.
    </x.p>
  </template>
...
Using xstyled's `styled`, all font families defined are automatically binded to `font-family` attribute:
