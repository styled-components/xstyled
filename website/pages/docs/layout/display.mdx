...
Use `display="none"` to set an element to `display: none` and remove it from the page layout (compare with `visibility="hidden"` from the [visibility documentation](/docs/visibility/)).
