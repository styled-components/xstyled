...
| ---------------------------- | ------------------------------- |
| `overscrollBehavior=[value]` | `overscroll-behavior: [value];` |
...
<>
  ...
  <Box overscrollBehavior="auto">Lorem ipsum dolor sit amet...</Box>
</>
```
...
<>
  ...
  <Box overscrollBehavior="contain">Lorem ipsum dolor sit amet...</Box>
</>
```
...
<>
  ...
  <Box overscrollBehavior="none">Lorem ipsum dolor sit amet...</Box>
</>
```
...
```jsx
<Box overscrollBehavior={{ md: 'contain' }} />
```
