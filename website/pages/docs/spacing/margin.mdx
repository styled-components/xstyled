...
<>
  <template preview>
    <x.div
      ...
      mx={-5}
    >
      <x.div mx={5} bg="rose-200" borderRadius="md" overflow="hidden" pt={6}>
        <x.div
          bg="rose-500"
          display="flex"
          alignItems="center"
...
<>
  <template preview>
    <x.div
      ...
      fontFamily="mono"
    >
      <x.div bg="emerald-200" borderRadius="md" overflow="hidden" px={8}>
        <x.div bg="emerald-500" py={3} px={4}>
          mx=8
        </x.div>
      </x.div>
    </x.div>
...
<>
  <template preview>
    <x.div
      ...
      fontFamily="mono"
    >
      <x.div bg="indigo-200" borderRadius="md" overflow="hidden" py={8}>
        <x.div bg="indigo-500" py={3} px={4}>
          my=8
        </x.div>
      </x.div>
    </x.div>
...
<>
  <template preview>
    <x.div
      ...
      fontFamily="mono"
    >
      <x.div bg="fuchsia-200" borderRadius="md" overflow="hidden" p={8}>
        <x.div bg="fuchsia-500" py={3} px={4}>
          m=8
        </x.div>
      </x.div>
    </x.div>
