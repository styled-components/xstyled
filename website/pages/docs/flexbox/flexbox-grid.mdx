...
| `col=[ratio]` | `flex: 0 0 [percent];`<br />`max-width: [percent];`                                        |
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold">
      <Box row mx={-2} bg="emerald-200" borderRadius="md">
        <Box col px={2}>
          <Box bg="emerald-500" py={2} textAlign="center" borderRadius="md">
            col
          </Box>
        </Box>
        <Box col px={2}>
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold">
      <Box row>
        <Box col>
          <Box bg="light-blue-400" py={2} textAlign="center" borderRadius="md">
            col
          </Box>
        </Box>
        <Box col={1 / 2}>
          <Box bg="light-blue-500" py={2} textAlign="center" borderRadius="md">
            {`col={1 / 2}`}
          </Box>
        </Box>
        <Box col>
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold" spaceY={2}>
      <Box row>
        <Box col>
          <Box bg="red-500" py={2} textAlign="center" borderRadius="md">
            1 of 2
          </Box>
        </Box>
        <Box col>
...
Create equal-width columns that span multiple rows by inserting a `<Box w={1} />` where you want the columns to break to a new line.
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold">
      <Box row>
        <Box col>
          <Box bg="orange-500" py={2} textAlign="center" borderRadius="md">
            col
          </Box>
        </Box>
        <Box col>
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold" spaceY={2}>
      <Box row>
        <Box col>
          <Box bg="blue-400" py={2} textAlign="center" borderRadius="md">
            1 of 3
          </Box>
        </Box>
        <Box col={1 / 2}>
          <Box bg="blue-500" py={2} textAlign="center" borderRadius="md">
            2 of 3 (wider)
          </Box>
        </Box>
        <Box col>
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold" spaceY={2}>
      <Box row>
        <Box col>
          <Box bg="fuchsia-400" py={2} textAlign="center" borderRadius="md">
            1 of 3
          </Box>
        </Box>
        <Box col="auto">
...
<>
  <template preview>
    <Box mx={2} color="white" fontWeight="extrabold" spaceY={2}>
      <Box row>
        <Box col={{ xs: 1, md: 2 / 3 }}>
          <Box bg="violet-500" py={2} textAlign="center" borderRadius="md">
            {`{ xs: 1, md: 2 / 3 }`}
          </Box>
        </Box>
        <Box col={{ xs: 1 / 2, md: 1 / 3 }}>
          <Box bg="violet-500" py={2} textAlign="center" borderRadius="md">
            {`{ xs: 1 / 2, md: 1 / 3 }`}
          </Box>
        </Box>
      ...
      <Box row bg="violet-200" borderRadius="md">
        <Box col={1 / 2}>
          <Box bg="violet-500" py={2} textAlign="center" borderRadius="md">
            1 / 2
          </Box>
...
<>
  <template preview>
    <Box color="white" fontWeight="extrabold">
      <Box row bg="lime-200" borderRadius="md" mx={-2}>
        <Box col px={2}>
          <Box bg="lime-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col px={2}>
          <Box bg="lime-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
...
<>
  <template preview>
    <Box
      ...
      borderRadius="md"
    >
      <Box row borderRadius="md" m={-2}>
        <Box col={1 / 2} p={2}>
          <Box bg="teal-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={1 / 2} p={2}>
          <Box bg="teal-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
...
<>
  <template preview>
    <Box
      ...
      borderRadius="md"
    >
      <Box row borderRadius="md">
        <Box col={1 / 2} p={2}>
          <Box bg="rose-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={1 / 2} p={2}>
          <Box bg="rose-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
...
<>
  <template preview>
    <Box
      ...
      borderRadius="md"
    >
      <Box row mx={{ lg: -2 }} borderRadius="md">
        <Box col py={3} px={{ lg: 2 }}>
          <Box bg="amber-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col py={3} px={{ lg: 2 }}>
          <Box bg="amber-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
...
<>
  ...
  <Box row alignItems="flex-start" height={100}>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
  </Box>
  <Box row alignItems="center" height={100}>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
  </Box>
  <Box row alignItems="flex-end" height={100}>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
    <Box col>One of three columns</Box>
  </Box>
...
<>
  <template preview>
    <Box
      ...
      spaceY={2}
    >
      <Box row alignItems="flex-start" bg="emerald-200" borderRadius="md">
        <Box col={3 / 4} py={2}>
          <Box bg="emerald-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={1 / 3} py={2}>
...
<>
  <template preview>
    <Box
      ...
      spaceY={2}
    >
      <Box row alignItems="flex-start" bg="red-200" borderRadius="md">
        <Box col={{ xs: 1 / 2, sm: 1 / 4 }} py={2}>
          <Box bg="red-500" py={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={{ xs: 1 / 2, sm: 1 / 4 }} py={2}>
          <Box bg="red-500" py={2} textAlign="center" borderRadius="md" />
...
<>
  <template preview>
    <Box color="white" fontWeight="extrabold" overflow="hidden" p={2}>
      <Box row bg="amber-200" borderRadius="md">
        <Box col>
          <Box bg="amber-500" py={2} textAlign="center" borderRadius="md">
            First, but unordered
          </Box>
...
<>
  <template preview>
    <Box
      ...
      spaceY={2}
    >
      <Box row bg="blue-200" borderRadius="md">
        <Box col={1 / 3}>
          <Box bg="blue-500" p={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={1 / 3} ml="33.333%">
          <Box bg="blue-500" p={2} textAlign="center" borderRadius="md" />
        </Box>
      </Box>
      <Box row bg="blue-200" borderRadius="md">
...
<>
  <template preview>
    ...
    >
      <Box row bg="amber-200" borderRadius="md">
        <Box col={1 / 3}>
          <Box bg="amber-500" p={2} textAlign="center" borderRadius="md" />
        </Box>
        <Box col={1 / 3} ml="auto">
          <Box bg="amber-500" p={2} textAlign="center" borderRadius="md" />
        </Box>
...
<>
  <template preview>
    <Box
      ...
      spaceY={2}
    >
      <Box row bg="lime-200" borderRadius="md">
        <Box col={3 / 4} row>
          {/* {`Level 1: col={3 / 4}`} */}
          <Box col={2 / 3}>
            <Box bg="lime-500" p={2} textAlign="center" borderRadius="md">
              {`col={2 / 3}`}
            </Box>
          </Box>
          <Box col={1 / 3}>
