...
Control the hover background color of an element using the `hoverBg={color}` or `hoverBackgroundColor={color}` utitlies.
...
<>
  ...
  <x.button bg="indigo-500" hoverBg="indigo-800">
    Button
  </x.button>
</>
```
