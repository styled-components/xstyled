...
To give an element a linear gradient background, use one of the `backgroundImage="gradient-to-{direction}"` utilities, in combination with the [gradient color stop](@TODO-link) utilities.
