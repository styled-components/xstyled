...
<>
  ...
  <Box backgroundRepeat="repeat" backgroundImage="url(...)" />
</>
```
...
<>
  ...
  <Box backgroundRepeat="no-repeat" backgroundImage="url(...)" />
</>
```
...
<>
  ...
  <Box backgroundRepeat="repeat-x" backgroundImage="url(...)" />
</>
```
...
<>
  ...
  <Box backgroundRepeat="repeat-y" backgroundImage="url(...)" />
</>
```
...
```jsx
<Box backgroundRepeat={{ md: 'no-repeat' }} />
```
