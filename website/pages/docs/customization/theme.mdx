...
| `space`                | `margin`, `margin-top`, `margin-bottom`, `margin-left`, `margin-right`, `margin-inline-start`, `margin-inline-end`, `padding`, `padding-top`, `padding-bottom`, `padding-left`, `padding-right`, `gap`, `grid-gap`, `grid-row-gap`, `grid-column-gap` |
