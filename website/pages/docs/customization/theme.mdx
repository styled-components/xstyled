...
See the [theme configuration reference](/docs/theme/) or the [default theme](https://github.com/smooth-code/xstyled/blob/master/packages/system/src/defaultTheme.ts) for a complete list of theme options.
...
For a complete reference of available theme properties and their default values, see [the default theme configuration](https://github.com/smooth-code/xstyled/blob/master/packages/system/src/defaultTheme.ts).
