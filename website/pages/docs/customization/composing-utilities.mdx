...
| `space`         | `margin`, `marginTop`, `marginRight`, `marginBottom`, `marginLeft`, `marginInlineStart`, `marginInlineEnd`, `mx`, `my`, `padding`, `paddingTop`, `paddingRight`, `paddingBottom`, `paddingLeft`, `px`, `py`, `spaceY`, `spaceX`, `spaceXReverse`, `spaceYReverse`                                  |
| `svg`           | `fill`, `stroke`                                                                                                                                                                                                                                           |
